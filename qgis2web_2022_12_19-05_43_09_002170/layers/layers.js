...
lyr_OpenStreetMap_0.setVisible(true);lyr_building_1.setVisible(true);lyr_buildpleburan_2.setVisible(true);lyr_schoolpleburan_3.setVisible(true);lyr_mosquepleburan_4.setVisible(true);lyr_streetpleburan_5.setVisible(true);lyr_pleburan_6.setVisible(true);lyr_Jalan_7.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_building_1,lyr_buildpleburan_2,lyr_schoolpleburan_3,lyr_mosquepleburan_4,lyr_streetpleburan_5,lyr_pleburan_6,lyr_Jalan_7];
...
lyr_Jalan_7.set('fieldAliases', {'FID_Admini': 'FID_Admini', 'OBJECTID': 'OBJECTID', 'FID_mfd_20': 'FID_mfd_20', 'FID_ADMI_1': 'FID_ADMI_1', 'WADMPR': 'WADMPR', 'KODE_KAB': 'KODE_KAB', 'KABUPATEN': 'KABUPATEN', 'DESA': 'DESA', 'KODE_KEC': 'KODE_KEC', 'KECAMATAN': 'KECAMATAN', 'ID_2018': 'ID_2018', 'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', });
...
lyr_Jalan_7.set('fieldImages', {'FID_Admini': '', 'OBJECTID': '', 'FID_mfd_20': '', 'FID_ADMI_1': '', 'WADMPR': '', 'KODE_KAB': '', 'KABUPATEN': '', 'DESA': '', 'KODE_KEC': '', 'KECAMATAN': '', 'ID_2018': '', 'Shape_Leng': '', 'Shape_Area': '', });
...
lyr_Jalan_7.set('fieldLabels', {'FID_Admini': 'no label', 'OBJECTID': 'no label', 'FID_mfd_20': 'no label', 'FID_ADMI_1': 'no label', 'WADMPR': 'no label', 'KODE_KAB': 'no label', 'KABUPATEN': 'no label', 'DESA': 'no label', 'KODE_KEC': 'no label', 'KECAMATAN': 'no label', 'ID_2018': 'no label', 'Shape_Leng': 'no label', 'Shape_Area': 'no label', });
